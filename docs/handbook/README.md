...
6. [Database & schema](06-database.md) — why PostgreSQL (over SQLite and SQL Server), migrations, tables and relationships.
7. [Testing & smoke test](07-testing.md) — five layers (backend unit, PostgreSQL integration, in-process API, frontend component, end-to-end smoke), the coverage floors CI enforces, and how to run each locally.
8. [Bugs & lessons learned](08-bugs-and-lessons.md) — 48 real bugs, how each was found, fixed, and prevented — from CI-as-compiler through deployment, test coverage, and a security and operability review.
