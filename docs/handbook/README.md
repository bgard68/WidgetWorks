...
8. [Bugs & lessons learned](08-bugs-and-lessons.md) — 39 real bugs, how each was found, fixed, and prevented — from CI-as-compiler through deployment and test coverage.
