...
8. [Bugs & lessons learned](08-bugs-and-lessons.md) — 45 real bugs, how each was found, fixed, and prevented — from CI-as-compiler through deployment, test coverage, and a security and operability review.
