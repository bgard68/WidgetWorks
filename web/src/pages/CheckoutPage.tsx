  ...
  return (
    <section className="checkout">
      ...
      <form onSubmit={placeOrder} className="form">
        ...
        <label>Payment token (demo)<input value={form.paymentToken} onChange={set('paymentToken')} /></label>
        <p className="muted small">Mock gateway: any token works; a token containing “decline” is rejected.</p>
